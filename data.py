...
def trainGenerator(batch_size,train_path,image_folder,mask_folder,aug_dict,image_color_mode = "rgb",
                    ...
                    flag_multi_class = False,num_class = 2,save_to_dir = "traingener/",target_size = (256,256),seed = 1):
    '''
...
def testGenerator(test_path,num_image = 1001,target_size = (256,256),flag_multi_class = False,as_gray = True):
    #image_prefix = 'ISIC_'
